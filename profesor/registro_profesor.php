...
<body>
    ...
    <div class="container">
		...
		<main>
			<div class="overlay">
            	<div class="popup">
    	            <form  action="archivo_registrar.php" method="post" enctype="application/x-www-form-urlencoded" class="needs-validation" novalidate>
    	            	<div class="form-group">
  						...
  						<div class="form-group">
    						<input type="password" name="registrar_contraseña" class="form-control" id="validationTooltip05" placeholder="Contraseña" required>
  						</div>
